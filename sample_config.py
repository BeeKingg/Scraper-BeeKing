...
class Config:
    ...
    APP_URL = os.environ.get("APP_URL", "https://t.me/MyTelegramDotOrgRobot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://t.me/MyTelegramDotOrgRobot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Thank You Very Much... 🙏 🇲🇨")
